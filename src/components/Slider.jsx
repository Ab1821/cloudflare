...
//                                 <div classNameName="bottomcaption col-md-6 ">
//                                     <h3>Mark Smith</h3>
//                                     <h6>Director of infrastructure</h6>
//                                 </div>
//                                 <div classNameName='compImg col-md-6'>
...
function Slider(props) {
    return (
        <>
            ...
            <div id="carouselExampleIndicators" class="carousel slidermain bg-light p-5" data-bs-ride="carousel">
                <div class="carousel-inner p-5">
                    <div class="carousel-item active">
                        ...
                        <div class="row mt-5">
                            <div class="bottomcaption col-md-6">
                                <h3>Mark Smith</h3>
                                <h6>Director of infrastructure</h6>
                                <div class="compImg ">
                                    <img src="img/companies/logo-discord-color.webp" alt="img" />
                    ...
                    <div class="carousel-item p-5">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="compImg col-md-6">
                                <img src="img/companies/DHL_logo_rgb_black_small.webp" alt="img" />
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item p-5">
                        <h2> "OneTrust relies on Cloudflare to maintain our network perimeter, so we can focus on delivering
                            technology that helps our customers be more trusted. With Cloudflare, we can easily build context-aware Zero Trust policies
                            for secure access to our developer tools. Employees can connect to the tools they need so simply teams
                            don’t even know Cloudflare is powering the backend. It just works."</h2>
                        <div class="row mt-5">
                            <div class="bottomcaption col-md-6">
                                <h3>Black brannon</h3>
                                <h6>CTO</h6>
